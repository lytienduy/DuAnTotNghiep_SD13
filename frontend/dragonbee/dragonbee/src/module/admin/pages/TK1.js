import { useState, useEffect } from "react"; // Thêm useEffect vào import đã có
import {
  Box,
  Typography,
  Paper,
...
// Component hiển thị từng thẻ doanh thu
    ...
    const fetchRevenueData = async () => {
      try {
        const [today, week, month, year] = await Promise.all([
          axios.get("/api/thong-ke/today"),
          axios.get("/api/thong-ke/week"),
          axios.get("/api/thong-ke/month"),
          axios.get("/api/thong-ke/year"),
        ]);

        setRevenueData([
          { ...today.data, icon: <CalendarTodayIcon fontSize="large" color="primary" /> },
          { ...week.data, icon: <EventNoteIcon fontSize="large" color="success" /> },
          { ...month.data, icon: <CalendarMonthIcon fontSize="large" color="warning" /> },
          { ...year.data, icon: <MonetizationOnIcon fontSize="large" color="error" /> },
        ]);
      } catch (error) {
