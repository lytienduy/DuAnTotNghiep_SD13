...
const [page, setPage] = useState(0);
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `http://localhost:8080/api/phongcach/phan-trang?page=${page}&size=${rowsPerPage}`
      )
      .then((response) => {
        console.log("Dữ liệu nhận được:", response.data);
        setPhongCachList(response.data.content);
      ...
      <Paper sx={{ padding: 3, mb: 3 }}>
              ...
              <Grid container spacing={2} alignItems="center">
                ...
                <Grid item xs={12} md={4}>
                  ...
                  <TextField
                    label="Tìm kiếm theo tên phong cách"
                    value={""}
       ...
       <Box
          ...
          >
            <Box display="flex" alignItems="center">
              ...
              <Typography ml={2}>Phong Cách</Typography>
            </Box>
            <Box display="flex" alignItems="center">
              <IconButton
