...
CREATE TABLE nhan_vien (
    ...
    cccd NVARCHAR(20) UNIQUE,               -- Số CCCD, đảm bảo không trùng lặp
    trang_thai NVARCHAR(50),                -- Trạng thái
    ngay_tao DATETIME DEFAULT GETDATE(),    -- Ngày tạo
    ngay_sua DATETIME,                      -- Ngày sửa
    nguoi_tao NVARCHAR(50),                 -- Người tạo
...
-- Bảng nhân viên
INSERT INTO nhan_vien (ma, id_tai_khoan, ten_nhan_vien, ngay_sinh, gioi_tinh, sdt, email, dia_chi, anh, cccd, trang_thai, ngay_tao, nguoi_tao)
VALUES 
('NV001', 2, N'Nguyễn Thị Nhân', '1985-03-10', N'Nữ', '0911111111', 'nhanvien1@example.com', N'123 Nguyễn Văn Linh, Phường Bình Hiên, Quận Hải Châu, Thành phố Đà Nẵng', 'uploads/nv001.jpg', '079123456789', N'Hoạt động', GETDATE(), 'Admin'),
('NV002', 6, N'Trần Văn Quản', '1990-06-15', 'Nam', '0922222222', 'nhanvien2@example.com', N'45 Lý Tự Trọng, Phường Bến Nghé, Quận 1, Thành phố Hồ Chí Minh', 'uploads/nv002.jpg', '079987654321', N'Vô hiệu hóa', GETDATE(), 'Admin'),
('NV003', 7, N'Lê Văn Nghĩa', '1995-11-20', 'Nam', '0933333333', 'nhanvien3@example.com', N'67 Trần Phú, Phường Hàng Bông, Quận Hoàn Kiếm, Thành phố Hà Nội', 'uploads/nv003.jpg', '079111222333', N'Hoạt động', GETDATE(), 'Admin'),
('NV004', 3, N'Hoàng Thị Yến', '1988-01-25', N'Nữ', '0944444444', 'nhanvien4@example.com', N'89 Pasteur, Phường Tân An, Quận Ninh Kiều, Thành phố Cần Thơ', 'uploads/nv004.jpg', '079444555666', N'Hoạt động', GETDATE(), 'Admin'),
('NV005', 8, N'Phạm Văn Bình', '1992-08-10', 'Nam', '0955555555', 'nhanvien5@example.com', N'12 Lê Hồng Phong, Phường Lạc Viên, Quận Ngô Quyền, Thành phố Hải Phòng', 'uploads/nv005.jpg', '079777888999', N'Hoạt động', GETDATE(), 'Admin');
